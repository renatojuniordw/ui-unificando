...
export const PricingCalculator = () => {
  ...
  const calculatePlan = () => {
    ...
    if (inboxes > PRICING.atendimento.base.includes.inboxes) {
      monthly +=
        (inboxes - PRICING.atendimento.base.includes.inboxes) *
        PRICING.atendimento.extras.inbox.priceMonthly;
    }

    if (attendants > PRICING.atendimento.base.includes.attendants) {
      monthly +=
        (attendants - PRICING.atendimento.base.includes.attendants) *
        ...
        <div className="max-w-6xl mx-auto bg-slate-50 border border-slate-200 rounded-[3rem] p-8 md:p-16 shadow-sm overflow-hidden text-left relative">
          <div className="grid md:grid-cols-2 gap-16 relative z-10">
            <div className="space-y-12">
              <div>
                ...
                <p className="text-sm text-slate-500 font-medium mb-12">
                  Ajuste os parâmetros para planejar seu investimento em
                  produtividade.
                </p>
              </div>
              ...
              <div>
                <label
                  htmlFor="inboxes-range"
                  className="block text-[10px] font-black text-slate-400 mb-6 uppercase tracking-widest"
                >
                  Número de Caixas de Entrada
                </label>
                <input
                  id="inboxes-range"
                  type="range"
                ...
                <div className="flex justify-between mt-4 text-[9px] font-black text-indigo-600 uppercase tracking-widest">
                  <span>1 Caixa</span>
                  <span>
                    {inboxes} {inboxes === 1 ? "Caixa" : "Caixas"}
                  </span>
                  <span>10 Caixas</span>
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  value={attendants}
                  onChange={(event) =>
                    setAttendants(Number(event.target.value))
                  }
                  className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-indigo-600"
                />
                <div className="flex justify-between mt-4 text-[9px] font-black text-indigo-600 uppercase tracking-widest">
                  ...
                  <span>
                    {attendants} {attendants === 1 ? "Atendente" : "Atendentes"}
                  </span>
            ...
            <div className="bg-slate-900 text-white rounded-[2.5rem] p-12 flex flex-col justify-between shadow-2xl">
              <div>
                <h4 className="text-indigo-400 font-black uppercase text-[10px] tracking-[0.2em] mb-12">
                ...
                <div className="space-y-10">
                  ...
                  <div>
                    <span className="block text-slate-500 text-[10px] uppercase font-black tracking-widest mb-3">
                      Mensalidade Unificada
                    </span>
                    <span className="text-5xl font-black tracking-tighter text-indigo-400">
