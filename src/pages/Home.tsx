        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <motion.div whileHover={{ y: -10 }} className="relative p-10 bg-slate-50 rounded-[3.5rem] border border-slate-200 hover:shadow-2xl transition-all group text-left">
              ...
              <button onClick={() => onNavigate(Page.Plans)} className="text-indigo-600 font-black inline-flex items-center gap-2 group-hover:gap-4 transition-all uppercase text-[10px] tracking-[0.2em]">
                Simular atendimento
              </button>
            </motion.div>
